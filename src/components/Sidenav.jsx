    ...
    <div>
        <AiOutlineMenu onClick={handleNav} className='absolute top-4 right-4 z-[99] md:hidden' />
        {
            nav ? (
                <div className='fixed w-full h-screen bg-white/90 flex flex-col justify-center items-center z-20'>
                    ...
                    <a href="https://drive.google.com/file/d/1_evU83jP8LEjvUAHZSl_Qs8Ve_myaklq/view?usp=sharing" onClick={handleNav} className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <BsPerson size={20} />
        ...
        <div className='md:block hidden fixed top-[25%] z-10'>
            <div className='flex flex-col'>
                ...
                <a href="https://drive.google.com/file/d/1_evU83jP8LEjvUAHZSl_Qs8Ve_myaklq/view?usp=sharing" className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                    <BsPerson size={20} />
                </a>
